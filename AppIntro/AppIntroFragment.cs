...
namespace AppIntro
{
    public class AppIntroFragment : AppIntroBaseFragment
    {
        public static AppIntroFragment NewInstance(string title, string description, int imageDrawable,
            int bgColor)
        {
        ...
        public static AppIntroFragment NewInstance(string title, string titleTypeFace, string description,
        ...
        protected override int LayoutId => Resource.Layout.fragment_intro;
    }
}